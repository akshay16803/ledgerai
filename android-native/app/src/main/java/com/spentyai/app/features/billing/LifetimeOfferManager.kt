 ...
 *
 * Tracks whether the 30-minute timed offer window is still open. The clock starts
 ...
 * platforms (single first-shown timestamp, 1800 s window, never reset).
 */
class LifetimeOfferManager private constructor(context: Context) {
    ...
    companion object {
        ...
        private const val OFFER_DURATION_MS = 1_800_000L // 30 minutes, matches iOS
