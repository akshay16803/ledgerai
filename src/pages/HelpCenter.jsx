...
const ARTICLES = [
  ...
  },
  {
    ...
    file: '02-email-sync-connect.png',
    body: [
  ...
  },
  {
    ...
    file: '03-pending-approval-list.png',
    body: [
  ...
  // Dashboard (5–7)
  {
    ...
    file: '05-dashboard-overview.png',
    body: [
  ...
  },
  {
    ...
    file: '06-pending-transaction-detail.png',
    body: [
  ...
  },
  {
    ...
    file: '12-new-transaction-form.png',
    body: [
  ...
  },
  {
    ...
    file: '13-transaction-filters.png',
    body: [
  ...
  },
  {
    ...
    file: '16-ai-created-account.png',
    body: [
  ...
  },
  {
    ...
    file: '31-empty-transactions.png',
    body: [
  ...
  if (article) {
    return (
      <div data-testid="help-center-article">
        ...
        <Screenshot file={article.file} alt={article.title} />
        <div style={{
          background: '#fff',
          border: '1px solid var(--border-subtle)',
          borderRadius: 2,
