  ...
  return (
    <div data-testid="transactions-page">
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 32 }}>
        <div>
          <h1 style={{ fontSize: 28, fontWeight: 500, letterSpacing: '-0.02em' }}>Transactions</h1>
              ...
              <div>
                ...
                {showQuickAcc && (
                  <div style={{ display: 'flex', gap: 6, marginTop: 6 }}>
                    <input data-testid="quick-account-name-input" value={quickAccName} onChange={e => setQuickAccName(e.target.value)} placeholder="Account name" style={{ ...inputStyle, flex: 1, padding: '6px 10px', fontSize: 12 }} />
